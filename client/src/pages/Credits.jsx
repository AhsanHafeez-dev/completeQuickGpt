  ...
  return (
    <div className='max-w-7xl h-screen overflow-y-scroll mx-auto px-4 sm:px-6 lg:px-8 py-12'>
      ...
      <div className='flex flex-wrap justify-center gap-8'>
        {plans.map((plan) =>
        (
          <div key={plan._id} className={`border border-gray-200 dark:border-purple-700  rounded-lh shadow hover:shadow-lg  transition-shadow p-6 min-w-[300px] flex flex-col ${plan._id == 'pro' ? 'bg-purple-50 dark:bg-purple-900' : 'bg-white dark:bg-transparent'}`}>
