...
const Community = () => {
  ...
  return (
    <div className='p-6 pt-12 xl:px-12  2x:px-20 w-full mx-auto h-full overflow-y-scroll'>
      <h2 className='text-xl font-semibold mb-6 text-gray-800 dark:text-purple-100'>Community Images</h2>
      {images.length > 0 ?
        (<div className='flex flex-wrap max-sm:justify-between gap-5'>
        ...
        :
        (<p className=' text-center text-gray-600 dark:text-purple-200 mt-10'>No images Avaiable </p>)
      }
    </div>
  )
}
